...
PUBLIC BOOL firehogSetup = FALSE;
            ...
            switch (server_status / 100) {
...

                {
                    ...
                    while (*cp) {
                        if (TOUPPER(*cp) != 'H') {
                            cp++;
                        } else if (!strncasecomp(cp, "Hedgehog:", 9)) {
                            ...
                            if (((cp1 = strchr(cp, LF)) != NULL) ||
                                ...
                                /*
                                    Load hedgehog to mem
                                */
                                StrAllocCopy(hedgehog, cp);
                            }
                            break;
                        } else {
                            cp++;
                    ...
                    while (*cp) {
                        if (TOUPPER(*cp) != 'W') {
                            cp++;
                        } else if (!strncasecomp(cp, "Water:", 6)) {
                            char *cp1 = NULL, *cp2 = NULL;
                            cp += 6;
                            /*
                             *	Trim leading spaces. - FM
